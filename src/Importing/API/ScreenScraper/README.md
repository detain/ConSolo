...
| name | Game Name (by Region) | mandatory |\
 |\
 | Text |
| editor | Editor |\
 |\
...
| players | Numbers of players) |\
 |\
 |\
 | Group name (see groups) |
| score | Note |\
 |\
 |\
 | Score out of 20 from 0 to 20 |
| rating | Classification |\
 |\
 | yes | Group name (see groups) |
| genres | Genre(s) |\
 |\
 | yes | French name of the group (see groups) |
| datessortie | Release date(s) | mandatory |\
 |\
 | Format: yyyy-mm-dd ("xxxx-01-01" if year only) |
| rotation | Rotation |\
 |\
 |\
 | 0 a 360 |
| resolution | Resolution |\
 |\
 |\
 | Text: Width x height in pixels (ex: 320x240) |
| modes | Game Mode(s) |\
 |\
 | yes | Text |
| families | Family(ies) |\
 |\
 | yes | Nom de la famille (ex: "Sonic" pour "Sonic 3D pinball") |
| number | Number |\
 |\
 | yes | Name of the series + Number in the series (ex: "sonic the Hedgehog 2") |
| styles | Style(s) |\
 |\
 | yes | Text: Graphic Style |
| themes | Theme(s) |\
 |\
 |\
 | Text: Game theme (e.g. "Vampire") |
...
| languages | Language (s) |\
 |\
 | yes | French name of the group (see groups) |
| clonetype | Type(s) de Clone |\
 |\
 | yes | Text |
| hacktype | Type(s) de Hack |\
 |\
 | yes | Text |
| friendly | Friend with... |\
 |\
 | yes | Text |
