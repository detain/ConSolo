...
CREATE TABLE `dat_games` (
  ...
  `romof` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL,
  `sampleof` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL,
  `board` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `dat_releases` (
  ...
  `language` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL,
  `date` varchar(300) COLLATE utf8mb4_bin DEFAULT NULL,
  `default` enum('yes','no') COLLATE utf8mb4_bin DEFAULT 'no',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `redump_roms`
--

DROP TABLE IF EXISTS `redump_roms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `redump_roms` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=145643 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tosec_roms`
--

DROP TABLE IF EXISTS `tosec_roms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tosec_roms` (
  ...
  `file` varchar(230) COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1034011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
