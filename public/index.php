...
$dispatcher = FastRoute\simpleDispatcher(function(FastRoute\RouteCollector $r) {
	...
	$r->get('[/]', ['\Detain\ConSolo\Models\Web', 'index']);
		...
		$r->get('/genres/{id:\d+}[/]', ['\Detain\ConSolo\Models\Web', 'genre']);
		...
		$r->get('/movies/collections/{id:\d+}[/]', ['\Detain\ConSolo\Models\Web', 'collection']);
		$r->get('/people[/]', ['\Detain\ConSolo\Models\Web', 'people']);
		$r->get('/people/{id:\d+}[/]', ['\Detain\ConSolo\Models\Web', 'person']);
	...
	$r->addGroup('/api', function (FastRoute\RouteCollector $r) {
		...
		$r->get('/genres/{id:\d+}[/]', ['\Detain\ConSolo\Models\Api', 'genre']);
		...
		$r->get('/movies/collections/{id:\d+}[/]', ['\Detain\ConSolo\Models\Api', 'collection']);
		$r->get('/people[/]', ['\Detain\ConSolo\Models\Api', 'people']);
		$r->get('/people/{id:\d+}[/]', ['\Detain\ConSolo\Models\Api', 'person']);
